...
const Footer = () => {
  ...
  if (isHomePage) {
    // Original light footer for home page
    return (
        ...
        <div className="border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Get the Clura newsletter</h3>
              <div className="max-w-md mx-auto flex gap-4">
                <input
                  type="email"
                  placeholder="name@email.com"
                  className="flex-1 px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-semibold text-gray-900">Clura</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/blog" className="text-gray-600 hover:text-gray-900 transition-colors">Blogs</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-600">hello@clura.ai</li>
